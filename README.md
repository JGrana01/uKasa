...
/usr/sbin/curl --retry 3 "https://raw.githubusercontent.com/JGrana01/huetil/master/ukasa" -o "/jffs/scripts/ukasa" && chmod 0755 /jffs/scripts/ukasa && /jffs/scripts/ukasa install

For Linux (i.e. Raspberry Pi)

/usr/bin/curl --retry 3 "https://raw.githubusercontent.com/JGrana01/huetil/master/ukasa" -o "$HOME/ukasa" && chmod 0755 $HOME/ukasa && $HOME/ukasa install
